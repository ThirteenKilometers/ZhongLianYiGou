package com.library.widgets.views;
...
public class TitleBar extends FrameLayout {
     ...
     * titleBar 的高度
     */
    private int mTitleBarHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 50, getResources().getDisplayMetrics());
     ...
     * 状态栏的背景色
     */
    private Drawable mTitleBarBg = new ColorDrawable(Color.WHITE);

    private String mTitleText = "";

    private int mTitleTextSize = 18;

    private int mTitleTextColor = ContextCompat.getColor(getContext(), R.color.color_666);

    private String mLeftText = "";

    private int mLeftTextColor = ContextCompat.getColor(getContext(), R.color.color_666);

    private int mLeftTextSize = 13;

    private Drawable mLeftTextImg = getResources().getDrawable(R.mipmap.guanbi);
    /**
     * 默认右边不显示
     */
    ...
    private int mRightTextColor = ContextCompat.getColor(getContext(), R.color.color_666);
